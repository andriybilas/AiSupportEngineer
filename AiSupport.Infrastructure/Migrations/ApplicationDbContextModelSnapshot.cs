...
namespace AiSupport.Infrastructure.Migrations
{
    ...
    partial class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("AiSupport.Infrastructure.DataBase.AppUser", b =>
            {
                b.Property<Guid>("Id").HasColumnType("uniqueidentifier");
                ...
                b.Property<DateTime>("CreatedDateTime").HasColumnType("datetime2");
                b.Property<DateTime>("UpdatedDateTime").HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AiSupport.Infrastructure.DataBase.AppService", b =>
            {
                b.Property<Guid>("Id").HasColumnType("uniqueidentifier");
                b.Property<string>("Name").HasColumnType("nvarchar(max)");
            ...
            {
                b.Property<Guid>("AppUserId").HasColumnType("uniqueidentifier");
                b.Property<Guid>("TenantId").HasColumnType("uniqueidentifier");
                b.HasKey("AppUserId", "TenantId");
                b.HasIndex("TenantId");
                b.ToTable("AppUserTenant");
            });

            modelBuilder.Entity("AiSupport.Infrastructure.DataBase.Tenant", b =>
            {
                b.Property<Guid>("Id").HasColumnType("uniqueidentifier");
                b.Property<string>("Name").HasColumnType("nvarchar(max)");
                b.HasKey("Id");
